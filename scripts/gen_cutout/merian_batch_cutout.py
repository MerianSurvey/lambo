...
def test_cutout():
    ...
    n708 = 'DECam/runs/merian/w_2022_02/t9813_deep'
    n540 = 'DECam/runs/merian/w_2022_02/t9813_deep'

    input_cat = os.path.join(output, 'stars_obj_cat_joint.fits')
    ...
    return sample_n708  # sample_n540  #sample_n708,
